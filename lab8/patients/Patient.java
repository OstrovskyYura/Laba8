...
public class Patient implements Comparable<Patient> {
    ...
    public Patient(String fullName, String address, String phone, int medicalCardNumber, String diagnosis) {
        tempId++;
        this.id = tempId;
    ...
    public int compareTo(Patient o) {
        ...
        if(c==0){
//            return String.compare(phone, o.phone);
        }
        return c;
    }
